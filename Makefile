...
CROSS=/home/hernan/CIAA_Software_1.1-linux-x64/tools/gcc-arm-embedded/bin/arm-none-eabi-
CC=$(CROSS)gcc
AS=$(CROSS)gcc
LD=$(CROSS)gcc
SIZE=$(CROSS)size
...
GDB=$(CROSS)gdb
OOCD=/home/hernan/CIAA_Software_1.1-linux-x64/tools/openocd/bin/openocd
